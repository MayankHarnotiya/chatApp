               ...
               <div className='  h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto scrollbar'>
                {
                    allUser.length===0 && (
                        <div className='mt-12'>
                            ...
                            <p className='text-lg text-center text-slate-400'>Explore user to start an conversation with.</p>
                        </div>
                    )
                }
                {
                    allUser.map((conv,index)=>{
                        return(
                            <NavLink to={("/"+conv?.userDetails?._id)} key={conv?._id} className="flex items-center gap-2 py-2 px-2 border border-transparent hover:border-primary rounded hover:bg-slate-100 cursor-pointer">
                                <div>
                                  <Avatar
                                            ...
                                            <div className='flex items-center gap-1' >
                                                  {
                                                    conv?.lastMsg.imageUrl &&(
                                                        <div className='flex items-center gap-1'>
                                                               <span className='text-xs'><FaImage/></span>
                                                  ...
                                                  }
                                                  {
                                                    conv?.lastMsg.videoUrl &&(
                                                        <div className='flex items-center gap-1'>
                                                               <span className='text-xs'><FaVideo/></span>
